package com.framework.meteor.framework.filter;//package com.colorfulmall.common.filter;
//
//
//
...
//
//
//import com.colorfulmall.common.constant.ResultMsg;
//import com.colorfulmall.common.util.SignFormat;
//import com.colorfulmall.common.util.StringUtil;
//
...
//                        str = "{\"code\":"+ ResultMsg.SIGN_ERROR.getCode()+",\"message\":\"签名错误\",\"body\":null,\"exceptionDescription\":null}";
//                    } else if (flagEnum.SCHOOL_ERROR.equals(flag)) {
//                        str = "{\"code\":"+ ResultMsg.DATA_POWER_ERROR.getCode()+",\"message\":\"数据权限错误\",\"body\":null,\"exceptionDescription\":null}";
//                    } else {
//                        str = "{\"code\":"+ResultMsg.DATA_POWER_ERROR.getCode()+",\"message\":\"数据权限错误\",\"body\":null,\"exceptionDescription\":null}";
//                    }
//                }
...
//        }catch (Exception e) {
//            e.printStackTrace();
//            str = "{\"code\":"+ResultMsg.SIGN_ERROR.getCode()+",\"message\":\"签名检查出错\",\"body\":null,\"exceptionDescription\":null}";
//            out = servletResponse.getWriter();
//            out.print(str);
//            out.flush();
//        } finally {
...
//           .append(httpServletRequest.getParameter("shopId") == null ? "" : "&shopId=" + httpServletRequest.getParameter("shopId"))
//           .append(httpServletRequest.getParameter("token") == null ? "" : "&");
//
////        System.out.println("来自请求的url----" + url);
//        String sign = SignFormat.getSignFormat(url.toString(), bodyBuilder.toString());//服务端签名算法
